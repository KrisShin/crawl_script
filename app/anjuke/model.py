...
class AnjukeSHCommunity(BaseModel):
    ...
    completion_year = fields.CharField(max_length=64,null=True, description="竣工年份")  # 1999
    property_years = fields.CharField(max_length=64,null=True, description="产权年限")  # 70
    total_households = fields.CharField(max_length=64,null=True, description="总户数")  # 762
    total_building_area = fields.CharField(max_length=64,null=True, description="总建筑面积 (㎡)")  # 70000.0
    plot_ratio = fields.CharField(max_length=64,null=True, description="容积率")  # 3.00
    greening_rate = fields.CharField(max_length=64,null=True, description="绿化率 (%)")  # 30.0
    ...
    unified_heating = fields.CharField(max_length=64,null=True, description="是否统一供暖")  # 否
    water_electricity_type = fields.CharField(max_length=32, null=True, description="供水供电类型")  # 民用
    parking_spaces_info = fields.CharField(max_length=64, null=True, description="停车位数")  # 70(1:0.1)
    property_fee = fields.CharField(max_length=64,null=True, description="物业费 (元/平米/月)")  # 1.20
